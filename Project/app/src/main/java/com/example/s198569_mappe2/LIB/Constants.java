package com.example.s198569_mappe2.LIB;
...
/**
 * Class for all the constants used repetitively in code
 */
public class Constants {
    ...
    public static final String REGULAR_EXPRESSION_8_TO_12_DIGITS = "(\\D*\\d){8,12}";
